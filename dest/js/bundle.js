...
},{"./pages/login":3,"./pages/nosense":4,"./pages/page404":5,"./pages/rightway":6,"./pages/ways":7,"./pages/wrongway":8,"jquery":1}],3:[function(require,module,exports){
var $ = require('jquery');
...
function init(params) {
    console.log('Hello from page 404');
}
